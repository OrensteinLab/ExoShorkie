...
SRR_LIST=("SRR15728907" "SRR15728908" "SRR15728909")

TMP_DIR="tmp"
STAR_INDEX_DIR="${TMP_DIR}/STAR_index"
OUTPUT_DIR="${TMP_DIR}/output"
GENOME_FA="dChr_reference.fa"
...
# === CLEANUP PART 2: remove replicate BAMs ===
...
bamCoverage -b "${TMP_DIR}/merged.bam" \
    -o "${OUTPUT_DIR}/merged_fwd_cpm.bw" \
...
bamCoverage -b "${TMP_DIR}/merged.bam" \
    -o "${OUTPUT_DIR}/merged_rev_cpm.bw" \
    --outFileFormat bigwig \
