...
echo "=== Running Mpneumo prediction ==="

python predict_kfold.py \
    --ablation \
    --src1-chrom Mpneumo \
...
echo "=== Running Human chr7 prediction ==="
python predict_kfold.py \
    --ablation \
...
echo "=== Running Mmmyco prediction ==="
python predict_kfold.py \
    --ablation \
    --src1-name Mmmyco \
    --src1-chrom Mmmyco \
...
echo "=== Running HPRT1R prediction ==="
python predict_kfold.py \
    --ablation \
    --src1-name HPRT1R \
    --src1-chrom HPRT1R \
